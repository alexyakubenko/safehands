  ...
  return (
    <html lang="ru">
      <body>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window, document, 'script', 'https://mc.yandex.ru/metrika/tag.js?id=109804927', 'ym');
              ym(109804927, 'init', {
                ssr: true,
                webvisor: true,
                clickmap: true,
        ...
        <noscript>
          <div>
            <img src="https://mc.yandex.ru/watch/109804927" style={{ position: "absolute", left: "-9999px" }} alt="" />
          </div>
        </noscript>
